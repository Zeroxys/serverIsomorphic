...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.getMoreViews = exports.More_View = exports.getPost = exports.GET_POST = exports.fetchPosts = exports.FETCH_POSTS = undefined;\n\nvar _axios = __webpack_require__(/*! axios */ \"axios\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _dateAndTime = __webpack_require__(/*! date-and-time */ \"date-and-time\");\n\nvar _dateAndTime2 = _interopRequireDefault(_dateAndTime);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar FETCH_POSTS = exports.FETCH_POSTS = 'fetch_posts';\n\nvar baseUrl = 'http://api.invent.mx/v1/actitudfem';\nvar apiKey = '22360f3a2e03f847acf5339695e42e5b';\n\nvar fetchPosts = exports.fetchPosts = function fetchPosts() {\n  return function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dispatch, getState, api) {\n      var res;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.t0 = console;\n              _context.next = 3;\n              return api.get('/users');\n\n            case 3:\n              _context.t1 = _context.sent;\n\n              _context.t0.log.call(_context.t0, _context.t1);\n\n              _context.next = 7;\n              return api.get('v1/actitudfem/nodes.json/' + apiKey + '?limite=5');\n\n            case 7:\n              res = _context.sent;\n\n              dispatch({\n                type: FETCH_POSTS,\n                payload: res\n              });\n\n            case 9:\n            case 'end':\n              return _context.stop();\n          }\n        }\n      }, _callee, undefined);\n    }));\n\n    return function (_x, _x2, _x3) {\n      return _ref.apply(this, arguments);\n    };\n  }();\n};\n\nvar GET_POST = exports.GET_POST = 'get_post';\nvar getPost = exports.getPost = function getPost() {\n  return function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(dispatch, getState, api) {\n      var res;\n      return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n          switch (_context2.prev = _context2.next) {\n            case 0:\n              _context2.next = 2;\n              return _axios2.default.get(baseUrl + '/node.json/' + apiKey + '?id=119585&fields=id%7Ctitle%7Csummary%7Curl%7Cimages%7Ctype');\n\n            case 2:\n              res = _context2.sent;\n\n              dispatch({\n                type: GET_POST,\n                payload: res\n              });\n\n            case 4:\n            case 'end':\n              return _context2.stop();\n          }\n        }\n      }, _callee2, undefined);\n    }));\n\n    return function (_x4, _x5, _x6) {\n      return _ref2.apply(this, arguments);\n    };\n  }();\n};\n\nvar More_View = exports.More_View = 'more_view';\nvar getMoreViews = exports.getMoreViews = function getMoreViews() {\n  return function () {\n    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(dispatch, getState, api) {\n      var timeStamp, now, dateNow, limitDay, dateYesterday, res;\n      return regeneratorRuntime.wrap(function _callee3$(_context3) {\n        while (1) {\n          switch (_context3.prev = _context3.next) {\n            case 0:\n              timeStamp = function timeStamp(date) {\n                var dateTime = new Date(date).getTime();\n\n                var timestamp = Math.floor(dateTime / 1000);\n\n                return timestamp;\n              };\n\n              now = new Date();\n              dateNow = timeStamp(_dateAndTime2.default.format(now, 'YYYY-MM-DD:00:00:00'));\n              limitDay = timeStamp(_dateAndTime2.default.format(_dateAndTime2.default.addDays(now, -6), 'YYYY-MM-DD:00:00:00'));\n              dateYesterday = timeStamp(_dateAndTime2.default.format(_dateAndTime2.default.addDays(now, -1), 'YYYY-MM-DD:00:00:00'));\n\n\n              console.log(limitDay);\n              console.log(dateYesterday);\n\n              _context3.next = 9;\n              return _axios2.default.get(baseUrl + '/node.json/' + apiKey + '?limit=9&created_start=' + limitDay + '&created_finish=' + dateYesterday + '&sort=visits.daycount:DESCfields=id|title|summary|taxonomy|url|images|sub_taxonomy|type');\n\n            case 9:\n              res = _context3.sent;\n\n              dispatch({\n                type: More_View,\n                payload: res\n              });\n\n            case 11:\n            case 'end':\n              return _context3.stop();\n          }\n        }\n      }, _callee3, undefined);\n    }));\n\n    return function (_x7, _x8, _x9) {\n      return _ref3.apply(this, arguments);\n    };\n  }();\n};\n\n//# sourceURL=webpack:///./client/actions/index.js?");
...
/***/ "./client/components/body/Article/index.js":
/*!*************************************************!*\
  !*** ./client/components/body/Article/index.js ***!
  \*************************************************/
/*! no static exports found */

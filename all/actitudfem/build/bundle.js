...
/***/ "./client/components/body/TitleSection/TitleSection.js":
/*!*************************************************************!*\
  !*** ./client/components/body/TitleSection/TitleSection.js ***!
  \*************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = __webpack_require__(/*! react */ \"react\");\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _reactRedux = __webpack_require__(/*! react-redux */ \"react-redux\");\n\nvar _actions = __webpack_require__(/*! ../actions/ */ \"./client/actions/index.js\");\n\nvar _reactHtmlParser = __webpack_require__(/*! react-html-parser */ \"react-html-parser\");\n\nvar _reactHtmlParser2 = _interopRequireDefault(_reactHtmlParser);\n\nvar _reactTweetEmbed = __webpack_require__(/*! react-tweet-embed */ \"react-tweet-embed\");\n\nvar _reactTweetEmbed2 = _interopRequireDefault(_reactTweetEmbed);\n\nvar _reactInstagramEmbed = __webpack_require__(/*! react-instagram-embed */ \"react-instagram-embed\");\n\nvar _reactInstagramEmbed2 = _interopRequireDefault(_reactInstagramEmbed);\n\nvar _reactSimpleDfp = __webpack_require__(/*! react-simple-dfp */ \"react-simple-dfp\");\n\nvar _reactSimpleDfp2 = _interopRequireDefault(_reactSimpleDfp);\n\nvar _reactShare = __webpack_require__(/*! react-share */ \"react-share\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar styles = {\n  figure: {\n    position: 'relative',\n    maxHeight: '200px',\n    overflow: 'hidden'\n  },\n  gradient: {\n    height: '100%',\n    width: '100%',\n    background: 'linear-gradient(to top, transparent 0%, rgba(0, 0, 0, 0.65) 100%, rgba(0, 0, 0, 0.65) 70%, transparent 30%)',\n    position: 'absolute'\n  },\n\n  title: {\n    color: '#000',\n    fontSize: '30px',\n    width: '95%',\n    margin: '10px auto',\n    lineHeight: '29px',\n    padding: '2px 5px',\n    textAlign: 'center'\n  },\n  p: {\n    color: '#666',\n    margin: '10px 12px'\n  },\n  autorLogo: {\n    width: '30px',\n    height: '23px',\n    marginRight: '8px'\n  },\n  contAutor: {\n    fontSize: '12px',\n    color: '#666',\n    width: '55%',\n    display: 'flex',\n    alignItems: 'center',\n    justifyContent: 'center',\n    margin: '10px auto',\n    padding: '8px 0',\n    borderBottom: '1px solid #666',\n    borderTop: '1px solid #666'\n  },\n  autor: {\n    marginLeft: '4px',\n    textTransform: 'uppercase'\n  },\n  dfp: {\n    margin: '0 auto',\n    display: 'flex',\n    justifyContent: 'center'\n  }\n};\n\nvar Article = function (_Component) {\n  _inherits(Article, _Component);\n\n  function Article() {\n    _classCallCheck(this, Article);\n\n    return _possibleConstructorReturn(this, (Article.__proto__ || Object.getPrototypeOf(Article)).apply(this, arguments));\n  }\n\n  _createClass(Article, [{\n    key: 'componentDidMount',\n    value: function componentDidMount() {\n      this.props.getPost();\n    }\n  }, {\n    key: 'taboola',\n    value: function (_taboola2) {\n      function taboola() {\n        return _taboola2.apply(this, arguments);\n      }\n\n      taboola.toString = function () {\n        return _taboola2.toString();\n      };\n\n      return taboola;\n    }(function () {\n      window._taboola = window._taboola || [];\n      taboola.push({ article: 'auto' });\n      !function (e, f, u, i) {\n        if (!document.getElementById(i)) {\n          e.async = 1;\n          e.src = u;\n          e.id = i;\n          f.parentNode.insertBefore(e, f);\n        }\n      }(document.createElement('script'), document.getElementsByTagName('script')[0], '//cdn.taboola.com/libtrc/[Publisher_Name]/loader.js', 'tb_loader_script');\n      if (window.performance && typeof window.performance.mark == 'function') {\n        window.performance.mark('tbl_ic');\n      }\n    })\n  }, {\n    key: 'taboola_print',\n    value: function taboola_print() {\n      window._taboola = window._taboola || [];\n      _taboola.push({ flush: true });\n    }\n  }, {\n    key: 'render',\n    value: function render() {\n      var data = this.props.post.data[0];\n      console.log(data);\n      var body = data.body;\n      var parse = (0, _reactHtmlParser2.default)(body);\n      parse.splice(3, 0, _react2.default.createElement(_reactSimpleDfp2.default, { adUnitPath: '/35139216/Actitudfem', adSize: [728, 90] }));\n      parse.push(_react2.default.createElement(_reactSimpleDfp2.default, { adUnitPath: '/35139216/Actitudfem', adSize: [728, 90] }));\n\n      return _react2.default.createElement(\n        'main',\n        null,\n        _react2.default.createElement(\n          'article',\n          null,\n          _react2.default.createElement(\n            'h1',\n            { style: styles.title },\n            this.props.post.data[0].title\n          ),\n          _react2.default.createElement(\n            'figure',\n            { style: styles.figure },\n            _react2.default.createElement('img', { src: this.props.post.data[0].images.files[0].url, alt: this.props.post.data[0].images.files[0].title })\n          ),\n          _react2.default.createElement(\n            'p',\n            { style: styles.author },\n            _react2.default.createElement(\n              'a',\n              { style: styles.contAutor, href: 'http://m.actitudfem.com/actitudfem' },\n              _react2.default.createElement('img', { style: styles.autorLogo, src: this.props.post.data[0]['autor-colaborador'].avatar }),\n              'Por  ',\n              _react2.default.createElement(\n                'span',\n                { style: styles.autor },\n                ' ',\n                this.props.post.data[0]['autor-colaborador'].name,\n                ' '\n              )\n            )\n          ),\n          _react2.default.createElement(\n            'div',\n            { style: styles.dfp },\n            _react2.default.createElement(_reactSimpleDfp2.default, { adUnitPath: '/35139216/Actitudfem', adSize: [728, 90] })\n          ),\n          _react2.default.createElement(\n            'div',\n            { style: styles.p, className: 'text-note' },\n            parse,\n            _react2.default.createElement(_reactTweetEmbed2.default, null),\n            _react2.default.createElement(_reactInstagramEmbed2.default, null)\n          )\n        ),\n        _react2.default.createElement(\n          'div',\n          { className: 'share_social' },\n          _react2.default.createElement(\n            _reactShare.FacebookShareButton,\n            { url: this.props.post.data[0].url },\n            ' ',\n            _react2.default.createElement('span', { className: 'share-facebook' }),\n            ' '\n          ),\n          _react2.default.createElement(\n            _reactShare.TwitterShareButton,\n            { url: this.props.post.data[0].url },\n            ' ',\n            _react2.default.createElement('span', { className: 'share-twitter' }),\n            ' '\n          ),\n          _react2.default.createElement(\n            _reactShare.WhatsappShareButton,\n            { url: this.props.post.data[0].url },\n            ' ',\n            _react2.default.createElement('span', { className: 'share-whatsapp' }),\n            ' '\n          )\n        ),\n        _react2.default.createElement('div', { id: 'script' })\n      );\n    }\n  }]);\n\n  return Article;\n}(_react.Component);\n\nvar mapStateToProps = function mapStateToProps(state) {\n  //console.log(state.post)\n  return { post: state.post };\n};\n\nvar loadData = function loadData(store, path) {\n  return store.dispatch((0, _actions.getPost)(path));\n};\n\nexports.default = {\n  loadData: loadData,\n  component: (0, _reactRedux.connect)(mapStateToProps, { getPost: _actions.getPost })(Article)\n};\n\n//# sourceURL=webpack:///./client/pages/PostPage.js?");
...
eval("module.exports = require(\"react-instagram-embed\");\n\n//# sourceURL=webpack:///external_%22react-instagram-embed%22?");
...
/***/ "react-simple-dfp":
/*!***********************************!*\
  !*** external "react-simple-dfp" ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = require(\"react-simple-dfp\");\n\n//# sourceURL=webpack:///external_%22react-simple-dfp%22?");
...
eval("module.exports = require(\"react-tweet-embed\");\n\n//# sourceURL=webpack:///external_%22react-tweet-embed%22?");
